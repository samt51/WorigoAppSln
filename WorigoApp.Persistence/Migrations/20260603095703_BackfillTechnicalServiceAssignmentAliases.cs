...
{
    /// <inheritdoc />
    public partial class BackfillTechnicalServiceAssignmentAliases : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql("""
                ...
                INNER JOIN [Department] targetDepartment
                   ...
                   AND (
                       targetDepartment.Name = sourceDepartment.Name
                       OR (sourceDepartment.Name = N'Teknik Servis' AND targetDepartment.Name = N'Teknik Servis Departmanı')
                   )
                ...
                USING (
                    SELECT
                        targetDepartment.HotelId AS TargetHotelId,
