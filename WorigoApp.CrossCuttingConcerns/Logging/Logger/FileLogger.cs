...
using Serilog;
using WorigoApp.CrossCuttingConcerns.Logging.ConfigurationModels;
using WorigoApp.CrossCuttingConcerns.Logging.Messages;
using WorigoApp.CrossCuttingConcerns.Logging.Serilog;

namespace WorigoApp.CrossCuttingConcerns.Logging.Logger
{
