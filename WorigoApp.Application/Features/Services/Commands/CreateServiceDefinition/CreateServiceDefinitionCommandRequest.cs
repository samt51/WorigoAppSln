...
{
/// <summary>
/// CreateServiceDefinitionCommandRequest sınıfını temsil eder.
/// </summary>
public class CreateServiceDefinitionCommandRequest : IRequest<ResponseDto<CreateServiceDefinitionCommandResponse>>
    {
/// <summary>
